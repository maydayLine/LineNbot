...
#c1.log("Auth Token : " + str(line.authToken))
####################################################
...
msg_dictt = {}
####################################################
if "u09b80ef1f1bc3a2de5840a9b3aaa3449" not in admin:
    ...
    try:
        ...
        if op.type == 26 or op.type == 25:
            ...
            if sender in admin:
                ...
                elif text.lower() == 'games on':
                    settings["gameswitch"] = True
                    cl.sendMessage(to, "遊戲已開啟 ✔")
                elif text.lower() == 'games off':
                    settings["gameswitch"] = False
                    cl.sendMessage(to, "遊戲已關閉 ✘")
                elif text.lower() == 'set':
                    try:
                        ret_ = "機器人狀態"
                        ret_ += "\n進群類型 開關"
                ...
                """            
                    ...
                    cl.sendImage(to, "linepy/ants/friedae.jpg")
                elif text.lower() == '?泰勒':
                    cl.sendImage(to, "linepy/ants/taylori.jpg")
                elif text.lower() == '?多樣':
                    cl.sendImage(to, "linepy/ants/diversa.jpg") 
                elif text.lower() == '?臭巨':
                    cl.sendImage(to, "linepy/ants/habereri.jpg")
                elif text.lower() == '?白疏':
                    cl.sendImage(to, "linepy/ants/albosparsus.jpg")
                elif text.lower() == '?甜蜜':
                    cl.sendImage(to, "linepy/ants/dulcis.jpg")
                elif text.lower() == '?希氏':
                    cl.sendImage(to, "linepy/ants/siemsseni.jpg")
                elif text.lower() == '?北巨':
                    cl.sendImage(to, "linepy/ants/formosensis.jpg")
                elif text.lower() == '?高雄':
                    cl.sendMessage(to, "貨出去 錢進來 高雄發大財！！！")
                    cl.sendImage(to, "linepy/ants/irritans.jpg")
                elif text.lower() == '?光滑家蟻':
                    cl.sendImage(to, "linepy/ants/Aphaenogaster.gif")
                elif text.lower() == '?雙脊家蟻':
                    cl.sendImage(to, "linepy/ants/bicarinatum.jpg")
                elif text.lower() == '?紅茶':
                    cl.sendImage(to, "linepy/ants/ceylonica.jpg")
                elif text.lower() == '?黑棘':
                    cl.sendImage(to, "linepy/ants/dives.jpg")
                elif text.lower() == '?麥氏':
                    cl.sendImage(to, "linepy/ants/illaudata.jpg")
                elif text.lower() == '?爪哇':
                    cl.sendImage(to, "linepy/ants/javanus.jpg")
                elif text.lower() == '?吉悌':
                    cl.sendImage(to, "linepy/ants/kitteli.jpg")
                elif text.lower() == '?哀愁':
                    cl.sendImage(to, "linepy/ants/moesta.jpg")
                elif text.lower() == '?高山鋸針':
                    cl.sendImage(to, "linepy/ants/monticola.jpg")
                elif text.lower() == '?勤勉':
                    cl.sendImage(to, "linepy/ants/nawai.jpg")
                elif text.lower() == '?日皺':
